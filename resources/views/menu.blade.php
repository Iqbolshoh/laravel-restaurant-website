...
<body class="bg-cream font-sans text-dark antialiased">
    ...
    <!-- Navigatsiya (menu.html uchun faol holat) -->
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex items-center space-x-8 font-medium text-gray-700">
                    <a href="index.html" class="hover:text-gold transition border-b-2 border-transparent pb-1">Bosh sahifa</a>
                    <a href="menu.html" class="text-gold border-b-2 border-gold pb-1">Menyu</a>
                    <a href="team.html" class="hover:text-gold transition border-b-2 border-transparent pb-1">Jamoa</a>
                    <a href="contact.html" class="hover:text-gold transition border-b-2 border-transparent pb-1">Aloqa</a>
                </nav>

                <div class="hidden md:block">
                    <a href="contact.html" class="bg-gold text-white px-6 py-2.5 rounded-full font-semibold hover:bg-amber-700 transition shadow-md hover:shadow-lg text-sm">
                        Stol band qilish
                    </a>
                </div>
            ...
            <div id="mobile-menu" class="md:hidden hidden mobile-menu pb-4 pt-2 space-y-3 bg-white/95">
                <a href="index.html" class="block py-2 px-3 rounded-lg hover:bg-softgray font-medium">Bosh sahifa</a>
                <a href="menu.html" class="block py-2 px-3 rounded-lg bg-softgray font-medium text-gold">Menyu</a>
                <a href="team.html" class="block py-2 px-3 rounded-lg hover:bg-softgray font-medium">Jamoa</a>
                <a href="contact.html" class="block py-2 px-3 rounded-lg hover:bg-softgray font-medium">Aloqa</a>
                <a href="contact.html" class="block w-full text-center bg-gold text-white py-3 rounded-full font-semibold mt-2">Stol band qilish</a>
            </div>
        </div>
    </header>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="index.html" class="hover:text-gold transition">Bosh sahifa</a></li>
                        <li><a href="menu.html" class="text-gold">Menyu</a></li>
                        <li><a href="team.html" class="hover:text-gold transition">Jamoa</a></li>
                        <li><a href="contact.html" class="hover:text-gold transition">Aloqa</a></li>
                    </ul>
                </div>
                <div>
