        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            <div class="flex justify-between items-center h-20">
                ...
                <nav class="hidden md:flex items-center space-x-8 font-medium text-gray-700">
                    <a href="/index" class="text-gold border-b-2 border-gold pb-1">Bosh sahifa</a>
            ...
            <div id="mobile-menu" class="md:hidden hidden mobile-menu pb-4 pt-2 space-y-3 bg-white/95">
                <a href="/index" class="block py-2 px-3 rounded-lg bg-softgray font-medium text-gold">Bosh sahifa</a>
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-8">
                ...
                <div>
                    ...
                    <ul class="space-y-2 text-sm">
                        <li><a href="/index" class="text-gold">Bosh sahifa</a></li>
